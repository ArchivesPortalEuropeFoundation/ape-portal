<div class="savedSearch" style="width: 100%" data-sort-item="collection"  data-sort-name="[[!+name]]" data-sort-id="[[!+id]]" data-sort-date="[[!+date_sort]]" data-search-filter-item="saved_collection" data-search-filter-field="[[!+name]]">
    ...
    <div class="contentDropdown">
        <div class="right">
            <a href="#" class="copyLink" data-copy-clipboard="[[++site_url]][[!~80]]?token=[[!+token]]" data-collection-id="[[!+id]]"><i class="fas fa-link"></i> [[!%asi.action_copy? &topic=`actions` &namespace=`asi`]]</a>
            <a class="editCollection disabled" data-trigger="collection_edit" data-collection-id="[[!+id]]"><i class="fas fa-pencil"></i> [[!%asi.action_edit_collection? &topic=`actions` &namespace=`asi`]]</a>
            <a class="finishEdit" data-trigger="collection_close" data-collection-id="[[!+id]]"><i class="fas fa-check"></i> [[!%asi.action_finish_editing? &topic=`actions` &namespace=`asi`]]</a>
