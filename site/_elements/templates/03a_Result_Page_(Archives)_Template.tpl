                    ...
                    <div class="buttons visible-xs">
                        ...
                        <div class="buttonDropdown">
                            ...
                            <div class="inner">
                                ...
                                <a href="[[!++site_url]][[!+metacontent.metacontent.url]]" id="copyUrl" class="copyUrl"><i class="fas fa-link"></i> <span>[[!%asi.tools_copy_link? &topic=`default` &namespace=`asi`]]</span></a>
                            </div>
                        </div>
                        [[-<div class="buttonDropdown">
